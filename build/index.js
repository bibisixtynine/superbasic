(() => {
  ...
  var seasonTimeCorrection = 1;
  function now() {
    let date = new Date();
    return ("0" + date.getDate()).slice(-2) + "/" + ("0" + (date.getMonth() + 1)).slice(-2) + " " + ("0" + (date.getHours() + seasonTimeCorrection)).slice(-2) + ":" + ("0" + date.getMinutes()).slice(-2) + ":" + ("0" + date.getSeconds()).slice(-2) + "." + ("000" + date.getMilliseconds()).slice(-3);
  }
  function log(string3) {
    console.log(now() + " -> " + string3);
  }
  if ("speechSynthesis" in window) {
    window.speechSynthesis.cancel();
  }
  log("+----------------------------------");
  log("\u{1F60D} zutils.js");

  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/text/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/state/dist/index.js
  var DefaultSplit = /\r\n?|\n/;
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/style-mod/src/style-mod.js
  var C = "\u037C";
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/rangeset/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/w3c-keyname/index.es.js
  var base = {
    8: "Backspace",
    9: "Tab",
    10: "Enter",
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/view/dist/index.js
  ...
  var DocView = class extends ContentView {
    ...
    updateChildren(changes, oldLength) {
      ...
      for (let i = changes.length - 1; ; i--) {
        ...
        let { content: content3, breakAtStart, openStart, openEnd } = ContentBuilder.build(this.view.state.doc, fromB, toB, this.decorations, this.pluginDecorationLength);
  ...
  function posAtCoords(view, { x, y }, precise, bias = -1) {
    ...
    if (lineStart < view.viewport.from)
      return view.viewport.from == 0 ? 0 : precise ? null : posAtCoordsImprecise(view, content3, block, x, y);
    if (lineStart > view.viewport.to)
      return view.viewport.to == view.state.doc.length ? view.state.doc.length : precise ? null : posAtCoordsImprecise(view, content3, block, x, y);
  ...
  function posAtCoordsImprecise(view, contentRect, block, x, y) {
    ...
    let content3 = view.state.sliceDoc(block.from, block.to);
    return block.from + findColumn(content3, into, view.state.tabSize);
  }
  ...
  function measureRange(view, range) {
    ...
    let content3 = view.contentDOM, contentRect = content3.getBoundingClientRect(), base2 = getBase(view);
    let lineStyle = window.getComputedStyle(content3.firstChild);
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/history/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@lezer/common/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/language/dist/index.js
  var _a;
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/gutter/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/fold/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/matchbrackets/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/commands/dist/index.js
  ...
  function moveBySyntax(state, start, forward) {
    ...
    let bracket3 = pos.type.prop(bracketProp), match, newPos;
    if (bracket3 && (match = forward ? matchBrackets(state, pos.from, 1) : matchBrackets(state, pos.to, -1)) && match.matched)
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/closebrackets/dist/index.js
  var defaults2 = {
    brackets: ["(", "[", "{", "'", '"'],
    before: ")]}:;>"
  };
  ...
  function insertBracket(state, bracket3) {
    ...
    for (let tok of tokens) {
      ...
      if (bracket3 == closed && closedBracketAt(state, state.selection.main.from))
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/panel/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/crelt/index.es.js
  function crelt() {
    var elt = arguments[0];
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/search/dist/index.js
  ...
  var SearchPanel = class {
    constructor(view) {
      ...
      function button2(name3, onclick, content3) {
        return crelt("button", { class: "cm-button", name: name3, onclick, type: "button" }, content3);
      }
      this.dom = crelt("div", { onkeydown: (e) => this.keydown(e), class: "cm-search" }, [
        this.searchField,
        button2("next", () => findNext(view), [phrase(view, "next")]),
        button2("prev", () => findPrevious(view), [phrase(view, "previous")]),
        button2("select", () => selectMatches(view), [phrase(view, "all")]),
        crelt("label", null, [this.caseField, phrase(view, "match case")]),
        crelt("label", null, [this.reField, phrase(view, "regexp")]),
        ...view.state.readOnly ? [] : [
          crelt("br"),
          this.replaceField,
          button2("replace", () => replaceNext(view), [phrase(view, "replace")]),
          button2("replaceAll", () => replaceAll(view), [phrase(view, "replace all")]),
          crelt("button", {
            name: "close",
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/tooltip/dist/index.js
  ...
  var showHoverTooltipHost = /* @__PURE__ */ showTooltip.compute([showHoverTooltip], (state) => {
    let tooltips = state.facet(showHoverTooltip).filter((t3) => t3);
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/autocomplete/dist/index.js
  ...
  function optionContent(config2) {
    ...
    return content3.sort((a, b) => a.position - b.position).map((a) => a.render);
  }
  ...
  var CompletionTooltip = class {
    ...
    addInfoPane(content3) {
      let dom = this.info = document.createElement("div");
      dom.className = "cm-tooltip cm-completionInfo";
      dom.appendChild(content3);
  ...
  var Snippet = class {
    ...
    static parse(template2) {
      ...
      for (let line of template2.split(/\r\n?|\n/)) {
        while (m = /[#$]\{(?:(\d+)(?::([^}]*))?|([^}]*))\}/.exec(line)) {
          let seq = m[1] ? +m[1] : null, name3 = m[2] || m[3] || "", found = -1;
          for (let i = 0; i < fields.length; i++) {
            if (seq != null ? fields[i].seq == seq : name3 ? fields[i].name == name3 : false)
              found = i;
          }
          if (found < 0) {
            let i = 0;
            while (i < fields.length && (seq == null || fields[i].seq != null && fields[i].seq < seq))
              i++;
            fields.splice(i, 0, { seq, name: name3 });
            found = i;
            for (let pos of positions)
              if (pos.field >= found)
                pos.field++;
          ...
          line = line.slice(0, m.index) + name3 + line.slice(m.index + m[0].length);
        }
        lines.push(line);
      }
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/comment/dist/index.js
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/rectangular-selection/dist/index.js
  var MaxOff = 2e3;
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/highlight/dist/index.js
  var nextTagID = 0;
  var Tag = class {
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@codemirror/lint/dist/index.js
  ...
  function renderDiagnostic(view, diagnostic, inPanel) {
    ...
    return crelt("li", { class: "cm-diagnostic cm-diagnostic-" + diagnostic.severity }, crelt("span", { class: "cm-diagnosticText" }, diagnostic.message), (_a2 = diagnostic.actions) === null || _a2 === void 0 ? void 0 : _a2.map((action, i) => {
      ...
      let { name: name3 } = action, keyIndex = keys2[i] ? name3.indexOf(keys2[i]) : -1;
      ...
      return crelt("button", {
        ...
        onclick: click,
        onmousedown: click,
        "aria-label": ` Action: ${name3}${keyIndex < 0 ? "" : ` (access key "${keys2[i]})"`}.`
      }, nameElt);
  ...
  // ../rbd/pnpm-volume/app/node_modules/@codemirror/basic-setup/dist/index.js
  var basicSetup = [
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@lezer/lr/dist/index.js
  var Stack = class {
  ...
  // ../rbd/pnpm-volume/c2efa4f7-fa0f-4c07-ad99-baa22afbe8e4/node_modules/@lezer/javascript/dist/index.es.js
  var noSemi = 279;
  var incdec = 1;
  var incdecPrefix = 2;
  ...
  // ../rbd/pnpm-volume/app/node_modules/@codemirror/lang-javascript/dist/index.js
  var snippets = [
  ...
  // ../rbd/pnpm-volume/app/node_modules/@codemirror/highlight/dist/index.js
  var nextTagID2 = 0;
  var Tag2 = class {
    constructor(set, base2, modified) {
      this.set = set;
  ...
  var Modifier2 = class {
    ...
    static get(base2, mods) {
      if (!mods.length)
        return base2;
      let exists = mods[0].instances.find((t3) => t3.base == base2 && sameArray3(mods, t3.modified));
      if (exists)
        return exists;
      let set = [], tag = new Tag2(set, base2, mods);
      for (let m of mods)
        m.instances.push(tag);
      let configs = permute2(mods);
      for (let parent of base2.set)
        for (let config2 of configs)
          set.push(Modifier2.get(parent, config2));
      return tag;
    }
  };
  function sameArray3(a, b) {
    return a.length == b.length && a.every((x, i) => x == b[i]);
  }
  function permute2(array) {
    let result = [array];
    for (let i = 0; i < array.length; i++) {
      for (let a of permute2(array.slice(0, i).concat(array.slice(i + 1))))
        result.push(a);
    }
    return result;
  }
  var ruleNodeProp2 = /* @__PURE__ */ new NodeProp();
  var highlightStyle2 = /* @__PURE__ */ Facet.define({
    combine(stylings) {
      return stylings.length ? HighlightStyle2.combinedMatch(stylings) : null;
    }
  });
  var fallbackHighlightStyle2 = /* @__PURE__ */ Facet.define({
    combine(values) {
      return values.length ? values[0].match : null;
    }
  });
  function getHighlightStyle2(state) {
    return state.facet(highlightStyle2) || state.facet(fallbackHighlightStyle2);
  }
  var HighlightStyle2 = class {
    constructor(spec, options) {
      this.map = Object.create(null);
      let modSpec;
      function def(spec2) {
      ...
      this.scope = options.scope || null;
      this.match = this.match.bind(this);
      let ext = [treeHighlighter2];
      if (this.module)
        ext.push(EditorView.styleModule.of(this.module));
      this.extension = ext.concat(options.themeType == null ? highlightStyle2.of(this) : highlightStyle2.computeN([EditorView.darkTheme], (state) => {
        return state.facet(EditorView.darkTheme) == (options.themeType == "dark") ? [this] : [];
      }));
      this.fallback = ext.concat(fallbackHighlightStyle2.of(this));
    }
    match(tag, scope) {
      if (this.scope && scope != this.scope)
        return null;
    ...
    static get(state, tag, scope) {
      let style = getHighlightStyle2(state);
      return style && style(tag, scope || NodeType.none);
    }
  };
  var TreeHighlighter2 = class {
    constructor(view) {
      this.markCache = Object.create(null);
      this.tree = syntaxTree(view.state);
      this.decorations = this.buildDeco(view, getHighlightStyle2(view.state));
    }
    update(update) {
      let tree = syntaxTree(update.state), style = getHighlightStyle2(update.state);
      let styleChange = style != update.startState.facet(highlightStyle2);
      if (tree.length < update.view.viewport.to && !styleChange && tree.type == this.tree.type) {
        this.decorations = this.decorations.map(update.changes);
      } else if (tree != this.tree || update.viewportChanged || styleChange) {
        this.tree = tree;
    ...
    buildDeco(view, match) {
      ...
      let builder = new RangeSetBuilder();
      for (let { from, to } of view.visibleRanges) {
        highlightTreeRange2(this.tree, from, to, match, (from2, to2, style) => {
          builder.add(from2, to2, this.markCache[style] || (this.markCache[style] = Decoration.mark({ class: style })));
        });
      }
      return builder.finish();
  ...
  var HighlightBuilder2 = class {
    ...
    highlightRange(cursor, from, to, inheritedClass, depth, scope) {
      ...
      if (start >= to || end <= from)
        return;
      nodeStack2[depth] = type.name;
      if (type.isTop)
        scope = type;
      let cls = inheritedClass;
      let rule = type.prop(ruleNodeProp2), opaque = false;
      while (rule) {
        if (!rule.context || matchContext2(rule.context, nodeStack2, depth)) {
          for (let tag of rule.tags) {
            let st = this.style(tag, scope);
            if (st) {
              if (cls)
  ...
  function highlightTreeRange2(tree, from, to, style, span) {
    let builder = new HighlightBuilder2(from, style, span);
    builder.highlightRange(tree.cursor(), from, to, "", 0, tree.type);
    builder.flush(to);
  }
  function matchContext2(context, stack, depth) {
    if (context.length > depth - 1)
      return false;
    for (let d = depth - 1, i = context.length - 1; i >= 0; i--, d--) {
      let check = context[i];
  ...
  var t2 = Tag2.define;
  var comment2 = /* @__PURE__ */ t2();
  var name2 = /* @__PURE__ */ t2();
  var typeName2 = /* @__PURE__ */ t2(name2);
  var propertyName2 = /* @__PURE__ */ t2(name2);
  var literal2 = /* @__PURE__ */ t2();
  var string2 = /* @__PURE__ */ t2(literal2);
  var number2 = /* @__PURE__ */ t2(literal2);
  var content2 = /* @__PURE__ */ t2();
  var heading2 = /* @__PURE__ */ t2(content2);
  var keyword2 = /* @__PURE__ */ t2();
  var operator2 = /* @__PURE__ */ t2();
  var punctuation2 = /* @__PURE__ */ t2();
  var bracket2 = /* @__PURE__ */ t2(punctuation2);
  var meta2 = /* @__PURE__ */ t2();
  var tags2 = {
    comment: comment2,
    lineComment: /* @__PURE__ */ t2(comment2),
    blockComment: /* @__PURE__ */ t2(comment2),
    docComment: /* @__PURE__ */ t2(comment2),
    name: name2,
    variableName: /* @__PURE__ */ t2(name2),
    typeName: typeName2,
    tagName: /* @__PURE__ */ t2(typeName2),
    propertyName: propertyName2,
    attributeName: /* @__PURE__ */ t2(propertyName2),
    className: /* @__PURE__ */ t2(name2),
    labelName: /* @__PURE__ */ t2(name2),
    namespace: /* @__PURE__ */ t2(name2),
    macroName: /* @__PURE__ */ t2(name2),
    literal: literal2,
    string: string2,
    docString: /* @__PURE__ */ t2(string2),
    character: /* @__PURE__ */ t2(string2),
    attributeValue: /* @__PURE__ */ t2(string2),
    number: number2,
    integer: /* @__PURE__ */ t2(number2),
    float: /* @__PURE__ */ t2(number2),
    bool: /* @__PURE__ */ t2(literal2),
    regexp: /* @__PURE__ */ t2(literal2),
    escape: /* @__PURE__ */ t2(literal2),
    color: /* @__PURE__ */ t2(literal2),
    url: /* @__PURE__ */ t2(literal2),
    keyword: keyword2,
    self: /* @__PURE__ */ t2(keyword2),
    null: /* @__PURE__ */ t2(keyword2),
    atom: /* @__PURE__ */ t2(keyword2),
    unit: /* @__PURE__ */ t2(keyword2),
    modifier: /* @__PURE__ */ t2(keyword2),
    operatorKeyword: /* @__PURE__ */ t2(keyword2),
    controlKeyword: /* @__PURE__ */ t2(keyword2),
    definitionKeyword: /* @__PURE__ */ t2(keyword2),
    moduleKeyword: /* @__PURE__ */ t2(keyword2),
    operator: operator2,
    derefOperator: /* @__PURE__ */ t2(operator2),
    arithmeticOperator: /* @__PURE__ */ t2(operator2),
    logicOperator: /* @__PURE__ */ t2(operator2),
    bitwiseOperator: /* @__PURE__ */ t2(operator2),
    compareOperator: /* @__PURE__ */ t2(operator2),
    updateOperator: /* @__PURE__ */ t2(operator2),
    definitionOperator: /* @__PURE__ */ t2(operator2),
    typeOperator: /* @__PURE__ */ t2(operator2),
    controlOperator: /* @__PURE__ */ t2(operator2),
    punctuation: punctuation2,
    separator: /* @__PURE__ */ t2(punctuation2),
    bracket: bracket2,
    angleBracket: /* @__PURE__ */ t2(bracket2),
    squareBracket: /* @__PURE__ */ t2(bracket2),
    paren: /* @__PURE__ */ t2(bracket2),
    brace: /* @__PURE__ */ t2(bracket2),
    content: content2,
    heading: heading2,
    heading1: /* @__PURE__ */ t2(heading2),
    heading2: /* @__PURE__ */ t2(heading2),
    heading3: /* @__PURE__ */ t2(heading2),
    heading4: /* @__PURE__ */ t2(heading2),
    heading5: /* @__PURE__ */ t2(heading2),
    heading6: /* @__PURE__ */ t2(heading2),
    contentSeparator: /* @__PURE__ */ t2(content2),
    list: /* @__PURE__ */ t2(content2),
    quote: /* @__PURE__ */ t2(content2),
    emphasis: /* @__PURE__ */ t2(content2),
    strong: /* @__PURE__ */ t2(content2),
    link: /* @__PURE__ */ t2(content2),
    monospace: /* @__PURE__ */ t2(content2),
    strikethrough: /* @__PURE__ */ t2(content2),
    inserted: /* @__PURE__ */ t2(),
    deleted: /* @__PURE__ */ t2(),
    changed: /* @__PURE__ */ t2(),
    invalid: /* @__PURE__ */ t2(),
    meta: meta2,
    documentMeta: /* @__PURE__ */ t2(meta2),
    annotation: /* @__PURE__ */ t2(meta2),
    processingInstruction: /* @__PURE__ */ t2(meta2),
    definition: /* @__PURE__ */ Tag2.defineModifier(),
    constant: /* @__PURE__ */ Tag2.defineModifier(),
    function: /* @__PURE__ */ Tag2.defineModifier(),
    standard: /* @__PURE__ */ Tag2.defineModifier(),
    local: /* @__PURE__ */ Tag2.defineModifier(),
    special: /* @__PURE__ */ Tag2.defineModifier()
  };
  ...
  var classHighlightStyle2 = /* @__PURE__ */ HighlightStyle2.define([
  ...
  // ../rbd/pnpm-volume/app/node_modules/@codemirror/matchbrackets/dist/index.js
  var baseTheme10 = /* @__PURE__ */ EditorView.baseTheme({
    "&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
    "&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
  });
  var DefaultScanDist2 = 1e4;
  var DefaultBrackets2 = "()[]{}";
  var bracketMatchingConfig2 = /* @__PURE__ */ Facet.define({
    combine(configs) {
      return combineConfig(configs, {
        afterCursor: true,
        brackets: DefaultBrackets2,
        maxScanDistance: DefaultScanDist2
      });
    }
  });
  var matchingMark2 = /* @__PURE__ */ Decoration.mark({ class: "cm-matchingBracket" });
  var nonmatchingMark2 = /* @__PURE__ */ Decoration.mark({ class: "cm-nonmatchingBracket" });
  var bracketMatchingState2 = /* @__PURE__ */ StateField.define({
    create() {
      return Decoration.none;
    },
    update(deco, tr) {
      if (!tr.docChanged && !tr.selection)
        return deco;
      let decorations2 = [];
      let config2 = tr.state.facet(bracketMatchingConfig2);
      for (let range of tr.state.selection.ranges) {
        if (!range.empty)
          continue;
        let match = matchBrackets2(tr.state, range.head, -1, config2) || range.head > 0 && matchBrackets2(tr.state, range.head - 1, 1, config2) || config2.afterCursor && (matchBrackets2(tr.state, range.head, 1, config2) || range.head < tr.state.doc.length && matchBrackets2(tr.state, range.head + 1, -1, config2));
        if (!match)
          continue;
        let mark = match.matched ? matchingMark2 : nonmatchingMark2;
        decorations2.push(mark.range(match.start.from, match.start.to));
        if (match.end)
          decorations2.push(mark.range(match.end.from, match.end.to));
      }
  ...
  var bracketMatchingUnique2 = [
    bracketMatchingState2,
    baseTheme10
  ];
  function bracketMatching2(config2 = {}) {
    return [bracketMatchingConfig2.of(config2), bracketMatchingUnique2];
  }
  function matchingNodes2(node, dir, brackets) {
    let byProp = node.prop(dir < 0 ? NodeProp.openedBy : NodeProp.closedBy);
    if (byProp)
      return byProp;
    if (node.name.length == 1) {
  ...
  function matchBrackets2(state, pos, dir, config2 = {}) {
    let maxScanDistance = config2.maxScanDistance || DefaultScanDist2, brackets = config2.brackets || DefaultBrackets2;
    let tree = syntaxTree(state), node = tree.resolveInner(pos, dir);
    for (let cur2 = node; cur2; cur2 = cur2.parent) {
      let matches = matchingNodes2(cur2.type, dir, brackets);
      if (matches && cur2.from < cur2.to)
        return matchMarkedBrackets2(state, pos, dir, cur2, matches, brackets);
    }
    return matchPlainBrackets2(state, pos, dir, tree, node.type, maxScanDistance, brackets);
  }
  function matchMarkedBrackets2(_state, _pos, dir, token, matching, brackets) {
    let parent = token.parent, firstToken = { from: token.from, to: token.to };
    let depth = 0, cursor = parent === null || parent === void 0 ? void 0 : parent.cursor;
    if (cursor && (dir < 0 ? cursor.childBefore(token.from) : cursor.childAfter(token.to)))
      do {
        if (dir < 0 ? cursor.to <= token.from : cursor.from >= token.to) {
          if (depth == 0 && matching.indexOf(cursor.type.name) > -1 && cursor.from < cursor.to) {
            return { start: firstToken, end: { from: cursor.from, to: cursor.to }, matched: true };
          } else if (matchingNodes2(cursor.type, dir, brackets)) {
            depth++;
          } else if (matchingNodes2(cursor.type, -dir, brackets)) {
            depth--;
            if (depth == 0)
  ...
  function matchPlainBrackets2(state, pos, dir, tree, tokenType, maxScanDistance, brackets) {
    let startCh = dir < 0 ? state.sliceDoc(pos - 1, pos) : state.sliceDoc(pos, pos + 1);
    let bracket3 = brackets.indexOf(startCh);
    if (bracket3 < 0 || bracket3 % 2 == 0 != dir > 0)
      return null;
  ...
  // src/codemirror6.js
  log("\u{1F60D} codemirror6.js");
  var editor6 = document.getElementById("editor6");
  console.log(editor6);
  var initial_doc = `function hello(who = "world") {
  console.log(\`Hello, \${who}!\`)
}`;
  var editor = new EditorView({
    state: EditorState.create({
      doc: initial_doc,
      extensions: [basicSetup, javascript(), defaultHighlightStyle2.fallback, bracketMatching2()]
    }),
    parent: editor6
  });

  // src/index.js
  log("\u{1F929} index.js");
